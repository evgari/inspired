...
export const renderCart = ({render}) => {
  ...
  //     <li class="cart__item">
  //       <article class="item">
  //         <img class="item__image" src="img/card-img.jpg" alt="Пижама со штанами шелковая">

  //         <div class="item__cotent">
  ...
  //             <p class="item__color-title">Цвет</p>

  //             <div class="item__color-item color color_black color_check"></div>
  //           </div>

  //           <div class="item__size">
  //             <p class="item__size-title">Размер</p>
  ...
  //     <li class="cart__item">
  //       <article class="item">
  //         <img class="item__image" src="img/cart-img.jpg" alt="Бюстгальтер-Балконет Prague Full Cover">
